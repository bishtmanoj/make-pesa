...
$(document).ready(function () {
    ...
    $('input[id=profile-image]').change(function() {
        console.log($(this).val());
        var mainValue = $(this).val();
        if(mainValue == ""){
            document.getElementById("select-file").innerHTML = "Choose File";
        }else{
            document.getElementById("select-file").innerHTML = mainValue.replace("C:\\fakepath\\", "");
        }
    });
    ...
    $('input[id=id-file]').change(function() {
        console.log($(this).val());
        var mainValue = $(this).val();
        if(mainValue == ""){
            document.getElementById("select-id-file").innerHTML = "Choose File";
        }else{
            document.getElementById("select-id-file").innerHTML = mainValue.replace("C:\\fakepath\\", "");
        }
    });
    ...
    $('input[id=address-file]').change(function() {
        ...
        var mainValue = $(this).val();
        if(mainValue == ""){
            document.getElementById("select-address-file").innerHTML = "Choose File";
        }else{
            document.getElementById("select-address-file").innerHTML = mainValue.replace("C:\\fakepath\\", "");
        }
    });
