...
class Myaccount extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view($this->themename.'/layout/personal/home', $data);
	...
	******/
	public function wallet($page_type = '')
	{
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/wallet/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
	...
	public function activity() {
        ...
        if (!empty($this->input->get('transaction', TRUE))) {
            $config["base_url"] = base_url('myaccount/activity?transaction=' . $this->input->get('transaction', TRUE));
        } else {
            $config["base_url"] = base_url('myaccount/activity?transaction=&'.$this->input->get('start', TRUE).'&'.$this->input->get('end', TRUE).'');
        }
	...
	******/
	public function transfer($method = '')
	{
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/success', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
		...
		if (isset($_POST['payment-another'])) {
			...
			redirect('myaccount/transfer/request');
			
			} elseif ($this->session->type_sent == 'sent') {
				
				$this->session->unset_userdata(array('type_sent', 'requested_info', 'payer_id'));
				redirect('myaccount/transfer/send');
			}
		}
	...
	******/
	public function transfer_method($page_type)
	{
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/send/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
                }
                else
				...
				if ($receipt_check->status == 0) {
					...
					// User sessions store
						...
						redirect('myaccount/transfer/send/complete');
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/request/priview', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
                }
                else
				...
				if (!$this->core_model->request_money($this->input->post(NULL, TRUE))) {
					...
					redirect('myaccount/transfer/request');
						...
						redirect('myaccount/transfer/success');
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/send/repeat', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
                }
                else
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/transfer/send/priview', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
                }
                else
	...
	*/
	...
	public function settings($page_type) {
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/settings/account/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
		...
		if (isset($_POST['update-profile-name'])){
			...
			if ($this->form_validation->run() == FALSE) {
					...
					redirect('myaccount/settings/account');
	...
	$filefolder = './uploads/'.$this->session->id;
	 if(!file_exists($filefolder))
      ...
      if (!$filenameprotect) {
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/settings/security/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
		 ...
		 if ($this->form_validation->run() == FALSE)
                {
					...
					redirect('myaccount/settings/security');     
                }
                else
                {
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/settings/payments/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/personal/settings/notifications/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
	...
	*/
	...
	public function verification() {
		...
		$this->load->view($this->themename.'/layout/globe/personal/header_meta', $data);
		$this->load->view($this->themename.'/layout/globe/personal/header_navbar');
		$this->load->view($this->themename.'/layout/verification/home', $data);
		$this->load->view($this->themename.'/layout/globe/personal/footer_navbar');
		$this->load->view($this->themename.'/layout/globe/personal/footer_end');
	 ...
	 if(!file_exists($filefolder))
      ...
      if (!$filenameprotect) {
         $this->session->set_flashdata('verification_error_file_type', TRUE);
                redirect('myaccount/verification');
      }else {
		...
		$filedata = $filefolder.'/'.$dataprotect;
			...
			if($file_name)
            {
				...
				if ($this->site_settings->email_notification) {
					...
					$this->email->from($this->site_settings->email_notification_email, $this->site_settings->site_name);
    				$this->email->to($this->session->email);
    				$this->email->subject(''.$this->lang->line('verification_submit_address_email_subject').' '.$this->site_settings->site_name.'');
    				$this->email->message($this->load->view($this->themename.'/layout/email/address-verification-submit', $data, TRUE));
					...
					// SMS Notification
						...
						if ($this->site_settings->sms_infobip) {
						$to_number = $this->user->mobile;
						$sms_body = $this->user->full_name.''.$this->lang->line('verification_submit_address_sms_subject').'';
						$this->helper->infobip_sms($to_number, $sms_body);
						}//End infobip
						...
						array(
						'from' => $this->site_settings->twilio_number, // From a valid Twilio number
						'body' => $this->user->full_name.''.$this->lang->line('verification_submit_address_sms_subject').''
						)
						);
						}// End twilio
						}
