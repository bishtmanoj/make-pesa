      ...
      <div class="col-sm-15 col-md-15 col-md-offset-0">
		...
		<!-- Password -->
		<?php $this->load->view($this->themename.'/layout/personal/settings/security/tabs/password'); ?>
		<!-- End password -->
		
		<!-- PIN -->
		<?php $this->load->view($this->themename.'/layout/personal/settings/security/tabs/pin'); ?>
		<!-- End PIN -->
		...
		<!-- Modal form -->
		 <?php $this->load->view($this->themename.'/layout/personal/settings/security/tabs/modal/modal_security_password'); ?>
		 <?php $this->load->view($this->themename.'/layout/personal/settings/security/tabs/modal/modal_security_pin'); ?>
