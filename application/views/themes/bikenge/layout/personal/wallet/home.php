      ...
      <div class="col-sm-15 col-md-15 col-md-offset-0">
		...
		<?php $this->load->view($this->themename.'/layout/personal/wallet/sidebar'); ?>
		...
		// Bank remove failed alert.
		 ...
		 // Bank remove success alert.
  	    ...
  	    ?>
		<?php $this->load->view($this->themename.'/layout/personal/wallet/tabs/bank'); ?>  
		<?php $this->load->view($this->themename.'/layout/personal/wallet/tabs/cards'); ?>
		<?php $this->load->view($this->themename.'/layout/personal/wallet/tabs/modal_bank'); ?>
		<?php $this->load->view($this->themename.'/layout/personal/wallet/tabs/modal_card'); ?>
