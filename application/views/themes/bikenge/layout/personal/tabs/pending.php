		<div class="well">
		<h5><a href="<?php echo site_url().'myaccount/activity/'; ?>" class="well-margin-link-header"><?php echo $this->lang->line('summary_right_pending_h5'); ?>
		...
		<div class="panel panel-default panel-transaction">
			...
			<a href="'.site_url().'myaccount/resend_request/?id='.$pending->txn_id.'" onClick="event.stopPropagation();">Send a reminder</a> | 
			<a href="'.site_url().'myaccount/remove_request/?id='.$pending->txn_id.'" onClick="event.stopPropagation();">Cancel</a>
			</p>';
			...
			This request is waiting <a href="'.site_url().'myaccount/accept_requestmoney/?id='.$pending->txn_id.'&amount='.$pending->total.'&email='.$pending->sender_email.'&type=request" onClick="event.stopPropagation();">Send payment</a> | 
			<a href="'.site_url().'myaccount/cancel_requestmoney/?id='.$pending->txn_id.'" onClick="event.stopPropagation();">Cancel</a>
			</p>
