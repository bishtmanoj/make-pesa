	...
	<?php echo $this->lang->line('summary_right_mostout_avatar_button'); ?><?php echo $this->site_settings->site_name;?> <i class="fa fa-angle-down fa-lg" aria-hidden="true"></i>
	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_deposit_tigopesa_well_header_h5'); ?>
		</h5>
		...
		<div class="fund-paymet-mobile">
		  ...
		  <?php echo $this->lang->line('fund_add_send_form_label_info'); ?>
		  </h5>
		  </div>
		  <h3><?php echo $this->lang->line('fund_add_form_label_paybill'); ?> 
		  <?php echo $this->site_settings->tigopesa_paybill; ?>
		  </h3>
		  <h4><?php echo $this->lang->line('fund_add_form_label_reference'); ?> <?php echo $this->user->id; ?></h4>
		  <p><?php echo $this->lang->line('fund_add_form_label_reference_p_note'); ?></p>
		  </div>
		  </div>
