	...
	<?php echo $this->lang->line('summary_right_mostout_avatar_button'); ?><?php echo $this->site_settings->site_name;?> <i class="fa fa-angle-down fa-lg" aria-hidden="true"></i>
	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_withdraw_western_well_header_h5'); ?>
		</h5>
		 ...
		 // Fund withdraw success alert.
      	if ($this->session->fund_withdraw_success) {
      		echo '<div class="alert alert-success alert-dismissible" role="alert">
      			  	<a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
      				  '.$this->lang->line('fund_withdraw_western_success').'
      			  </div>';
      	}
		...
		<div class="form-group">
		<input type="text" name="name" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_western_form_name_validate'); ?>">
		</div>
		
		<div class="form-group">
		<input type="text" name="city" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_western_form_city_validate'); ?>">
		</div>
		
		<div class="form-group">
		<input type="text" name="country" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_western_form_country_validate'); ?>">
		</div>
		
		<div class="form-group">
		<input type="text" name="phone" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_western_form_phone_validate'); ?>">
		</div>
		...
		<div class="fund-paymet-mobile">
		  ...
		  <h3>
		  <?php echo $this->lang->line('fund_withdraw_form_label_western'); ?>
		  </h3>
		  <p></p>
		  </div>
		  </div>
          ...
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <button type="submit" class="fund-payment-button-submit" name="fund-withdraw-western">
