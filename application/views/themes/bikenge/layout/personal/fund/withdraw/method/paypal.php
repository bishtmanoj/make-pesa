	...
	<?php echo $this->lang->line('summary_right_mostout_avatar_button'); ?><?php echo $this->site_settings->site_name;?> <i class="fa fa-angle-down fa-lg" aria-hidden="true"></i>
	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_withdraw_paypal_well_header_h5'); ?>
		</h5>
		...
		<div class="form-group">
		<div class="input-group">
		<span class="input-group-addon" id="text-amount"><i class="fa fa-paypal fa-lg" aria-hidden="true"></i></span>
		<input type="text" name="paypal_email" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_paypal_form_email_validate'); ?>">
		</div>
		</div>
		...
		<div class="fund-paymet-mobile">
		  ...
		  <h3>
		  <?php echo $this->lang->line('fund_withdraw_form_label_paypal'); ?>
		  </h3>
		  <p></p>
		  </div>
		  </div>
          ...
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <button type="submit" class="fund-payment-button-submit" name="fund-withdraw-paypal">
