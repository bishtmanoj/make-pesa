		...
		// Fund card status alert.
		  ...
		  <!-- Card and Bank -->
		<?php $this->load->view($this->themename.'/layout/personal/fund/tabs/deposit/accept/card'); ?>
		  <?php endif; ?>
		  ...
		  <?php $this->load->view($this->themename.'/layout/personal/fund/tabs/deposit/accept/mobile'); ?>
		  <?php endif; ?>
		  ...
		  <?php $this->load->view($this->themename.'/layout/personal/fund/tabs/deposit/accept/other'); ?>
		  <?php endif; ?>
