      ...
      <div class="col-sm-15 col-md-15 col-md-offset-0">
		...
		Dispute waiting
		<h3>
		<a href="<?php echo site_url().'dispute/type/wait'; ?>">
		...
		Dispute Refunded
		<h3>
		<a href="<?php echo site_url().'dispute/type/refund'; ?>">
		...
		Dispute Canceling
		<h3>
		<a href="<?php echo site_url().'dispute/type/cancel'; ?>">
    ...
    <tbody>
		...
		<tr>
		<td>
		<input type="radio" name="dispute_send" value="<?php echo $dispute->txn_id;?>" id="dispute-<?php echo $dispute->txn_id;?>" required>
		</td>
		<td>
		...
		<button type="submit" class="dispute-button" name="send-dispute">Dispute</button>
		</tr>
		</form>
		<?php }?>
