      ...
      <div class="col-sm-15 col-md-15 col-md-offset-0">
		...
		<?php $this->load->view($this->themename.'/layout/business/verification/sidebar'); ?>
		...
		if ($this->session->verification_submit_failed) {
		 ...
		 // Verification submit success alert.
  	    ...
  	    ?>
		<?php $this->load->view($this->themename.'/layout/business/verification/tabs/document'); ?>  
		<?php $this->load->view($this->themename.'/layout/business/verification/tabs/modal_idcard'); ?>
		<?php $this->load->view($this->themename.'/layout/business/verification/tabs/modal_address'); ?>
