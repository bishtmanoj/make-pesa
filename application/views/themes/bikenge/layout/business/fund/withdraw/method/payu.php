	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_withdraw_payu_well_header_h5'); ?>
		</h5>
		...
		<div class="form-group">
		<div class="input-group">
		<span class="input-group-addon" id="text-amount"><i class="pf pf-payu pf-lg" aria-hidden="true"></i></span>
		<input type="text" name="payu_address" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_payu_form_address_validate'); ?>">
		</div>
		</div>
		...
		<div class="fund-paymet-mobile">
		  ...
		  <h3>
		  <?php echo $this->lang->line('fund_withdraw_form_label_payu'); ?>
		  </h3>
		  <p></p>
		  </div>
		  </div>
          ...
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <button type="submit" class="fund-payment-button-submit" name="fund-withdraw-payu">
