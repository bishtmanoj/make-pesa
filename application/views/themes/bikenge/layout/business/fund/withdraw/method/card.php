	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_withdraw_card_well_header_h5'); ?>
		</h5>
		 ...
		 // Fund add success alert.
      	if ($this->session->fund_withdraw_success) {
      		echo '<div class="alert alert-success alert-dismissible" role="alert">
      			  	<a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
      				  '.$this->lang->line('fund_withdraw_card_success').'
      			  </div>';
      	}
		...
		<div class="fund-payment-padding">
		  ...
		  <?php echo $this->lang->line('fund_withdraw_card_form_label_add_fund'); ?>
		  </h5>
		  <?php foreach($list_card as $card){?>
		  <div class="fund-payment-select">
		  <div class="fund-payment-select-primary">
            <input type="radio" name="card" id="card-<?php echo $card->id;?>" value="<?php echo $card->id;?>" required>
          ...
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <button type="submit" class="fund-payment-button-submit" name="fund-withdraw-card">
