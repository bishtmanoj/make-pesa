	  ...
	  <!-- End -->
		...
		<div class="well">
		<h5>
		<?php echo $this->lang->line('fund_withdraw_neteller_well_header_h5'); ?>
		</h5>
		...
		<div class="form-group">
		<input type="text" name="neteller_email" class="form-control" value="" placeholder="<?php echo $this->lang->line('fund_withdraw_neteller_form_email_validate'); ?>">
		</div>
		...
		<div class="fund-paymet-mobile">
		  ...
		  <h3>
		  <?php echo $this->lang->line('fund_withdraw_form_label_neteller'); ?>
		  </h3>
		  <p></p>
		  </div>
		  </div>
          ...
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <button type="submit" class="fund-payment-button-submit" name="fund-withdraw-neteller">
