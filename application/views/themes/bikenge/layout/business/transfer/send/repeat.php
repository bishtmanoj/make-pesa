	 ...
	 <?php
		 ...
		 <div class="send-payment-image-round">
			   ...
			   <p><?php echo $this->lang->line('transfer_send_form_sennding_to');?> <?php echo $this->input->get('email', TRUE); ?></p>
            </div>
			<!-- Start form -->
			<form method="post">
		...
		<input type="text" name="amount" id="sender_amount" class="form-control sendMoney" class="form-control" value="<?php echo $this->input->get('amount', TRUE); ?>"
		 placeholder="<?php echo $this->user->curr_symb.'0.00';?>">
		...
		<input type="hidden" name="next_email" value="<?php echo $this->input->get('email', TRUE); ?>">
		<div class="col-xs-6 col-md-6">
	 ...
	 <a href="<?php echo site_url().'business/transfer/send/cancel'; ?>" class="cancel-payment-button">
