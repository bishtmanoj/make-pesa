		...
		<h5><a href="<?php echo site_url().'business/activity/'; ?>" class="well-margin-link-header"><?php echo $this->lang->line('summary_right_transaction_h5'); ?>
		...
		<div class="panel panel-default panel-transaction">
			...
			<a href="'.site_url().'business/transfer/repeat/?email='.$money->receiver_email.'&amount='.$money->total.'" onClick="event.stopPropagation();">Repeat transaction </a>
			...
			if (empty($money->sender)) {
				...
				if ($money->payment_type == 'refund') {
					...
					$refund_button = '
				<form role="form" method="post" action="'.site_url('business/refund').'">
...
<!-- panel-group -->
			...
			<a href="<?php echo site_url().'business/activity/'; ?>"><?php echo $this->lang->line('summary_right_view_all_transaction'); ?></a>
			<?php endif; ?>
			</div>
          </div>