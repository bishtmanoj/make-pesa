	...
	<div class="panel panel-default">
		...
		<a href="<?php echo site_url().'business/activity/'; ?>" class="pull-right">Details <i class="fa fa-angle-right" aria-hidden="true"></i></a></b>
		</li>
	...
	<div class="panel-body">
			...
			<li>
			<b><a href="<?php echo site_url().'business/transfer/request'; ?>" class="request_summary"><?php echo $this->lang->line('summary_sidebar_request_fund'); ?></a>
	...
	<?php if ($sumcardbank_yesno+$sumbankac_yesno) {?>
		...
		<b><a href="<?php echo site_url().'business/wallet/'; ?>"><?php echo $this->lang->line('summary_sidebar_bankcard_link_wallet'); ?></a></b>
		</li>
	<?php } else {?>
	<p><?php echo $this->lang->line('summary_sidebar_bankcard_notes'); ?></p>
			<ul class="nav">
		<li>
		<b><a class="btn add-bank-card-button" href="<?php echo site_url().'business/wallet/'; ?>"><?php echo $this->lang->line('summary_sidebar_bankcard_link'); ?></a></b>
		</li>
	<?php }?>
