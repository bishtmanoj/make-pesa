 <!-- Add Bank -->
  <div class="modal face modal-fullscreen  footer-to-bottom" data-keyboard="false" data-backdrop="static" id="addbank" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
		  ...
		  <!-- Form of payment -->
		  <form role="form" method="post" action="<?php echo site_url('business/wallet/bank');?>">
