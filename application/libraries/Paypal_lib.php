...
class paypal_lib {
	...
	{		
		...
		$this->CI->site_settings = $this->CI->core_model->get_bk_core_settings();
		$this->CI->user = $this->CI->core_model->get_bk_core_user();
		
		$this->paypal_url = ($this->CI->site_settings->paypal_url_live == 0)?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
		...
		$this->add_field('business',$this->CI->site_settings->paypal_email);
		$this->add_field('rm','2');			  // Return method = POST
		$this->add_field('cmd','_xclick');

		$this->add_field('currency_code', $this->CI->user->curr_word);
	...
	function paypal_auto_form() 
	{
		...
		echo '<p style="text-align:center;">Please wait, your fund is being processed and you will be redirected to the paypal website.</p>' . "\n";
